    ...
    <div className=" shadow-md w-full  top-0 left-0">
      <div className=" md:flex items-center justify-between bg-[#ffffff] py-4 md:px-10 px-7">
        ...
        {/* <HiBars3 name={open ? "close":"menu"}/> */}
          ...
          <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-[#ffffff] md:z-auto z-1 left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? "top-20 ": "top-[-490px]"} `}>
